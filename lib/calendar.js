...
module.exports = function(options){
  return {
    update: function(calendarData, cb) {
      ...
      fs.readFile('.credentials/google_secret.json', function processClientSecrets(err, content) {
        if (err) {
  ...
  function authorize(credentials, callback) {
    ...
    fs.readFile(options.token_dir + options.token_path, function(err, token) {
      if (err) {
